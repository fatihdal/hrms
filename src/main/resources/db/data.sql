...
insert into public.job_seekers (date_of_birth, first_name, last_name, gender,national_id,email, enabled,locked ,password,role,phone)
VALUES ('10/6/1978', 'NESLIHAN', 'ZENGIN', 'WOMAN', '23480340824','1.userEmail1@example.com', true, false,'123456789', 'USER',2562611),
       ('3/8/1949','SADET', 'YILDIRIM', 'WOMAN', '17111553172','2.userEmail1@example.com', true, true,'123456789','USER',2562611);
